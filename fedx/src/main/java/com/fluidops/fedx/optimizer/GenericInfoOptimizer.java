...
public class GenericInfoOptimizer extends AbstractQueryModelVisitor<OptimizationException> implements FedXOptimizer {
	...
	// protected List<StatementPattern> stmts b= new ArrayList<StatementPattern>();
...
//	}
	...
	public void meet(Join node) {
		 ...
		 * Optimization task:
		 * 
		 * Collect all join arguments recursively and create the NJoin structure for
		 * easier join order optimization
		 */
