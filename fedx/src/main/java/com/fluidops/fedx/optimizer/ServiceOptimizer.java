...
/*
	...
	*/
	...
	/**
	 * Return the FedX endpoint corresponding to the given service URI. If there is
	 * no such endpoint in FedX, this method returns null.
	 * 
	 * Note that this method compares the endpoint URL first, however, that the name
	 * of the endpoint can be used as identifier as well. Note that the name must be
	 * a valid URI, i.e. start with http://
	 * 
	 * @param serviceUri
	 * @return
	 */
