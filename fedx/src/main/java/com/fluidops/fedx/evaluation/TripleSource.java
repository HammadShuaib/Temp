...
/**
 * Interface for implementations of triple sources. Particular implementations
 * define how to evaluate the expression on the endpoint. Different
 * implementations might be necessary depending on the underlying repository.
 * 
...
public interface TripleSource {
	...
	/**
	 * Evaluate the prepared query in its internal representation on the provided
	 * endpoint.
	 * 
	 * @param preparedQuery a prepared query to evaluate
	 * @param conn          the connection to the endpoint
	 * @param bindings      the bindings to use
	 * @param filterExpr    the filter expression to apply or null if there is no
	 *                      filter or if it is evaluated already
	 * 
	...
	/**
	 * Evaluate the prepared query (SPARQL query as String) on the provided
	 * endpoint.
	 * 
	...
	/**
	 * Return the statements matching the given pattern as a {@link Statement}
	 * iteration.
	 * 
	 * @param stmt the stmt expression to evaluate
	 * @param conn the connection to the endpoint
	 ...
	 * @param stmt
	 * @param conn
	 * @param bindings a binding set. in case no bindings are present, an
	 *                 {@link EmptyBindingSet} can be used (i.e. never null)
	 * 
	 * @return
	 * @throws RepositoryException
	 * @throws MalformedQueryException
	...
	/**
	 * Check if the repository can return results for the given triple pattern
	 * represented by subj, pred and obj
	 * 
	 * @param conn
	 * @param subj
	 * @param pred
	 ...
	 * {@link ExclusiveGroup}, i.e. a list of Statements
	 * 
	 * @param conn
	 * @param subj
	 * @param pred
