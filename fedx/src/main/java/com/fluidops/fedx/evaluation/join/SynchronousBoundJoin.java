...
/**
 * Execute the nested loop join in a synchronous fashion, using grouped
...
//	public static Logger log = LoggerFactory.getLogger(SynchronousBoundJoin.class);
	...
	public SynchronousBoundJoin(FederationEvalStrategy strategy,
			...
			QueryInfo queryInfo) throws QueryEvaluationException {
...
/*
		...
		while (!closed && leftIter.hasNext()) {
			...
			final CloseableIteration<BindingSet, QueryEvaluationException> cit = hasFreeVars
					? strategy.evaluateBoundJoinStatementPattern(stmt, bindings)
