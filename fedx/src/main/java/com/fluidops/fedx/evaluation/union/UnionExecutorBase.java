...
public abstract class UnionExecutorBase<T> extends LookAheadIteration<T, QueryEvaluationException> {
	...
	// protected QueueCursor<CloseableIteration<T, QueryEvaluationException>> result
	// = new QueueCursor<CloseableIteration<T, QueryEvaluationException>>(1024);
	protected QueueIterator<CloseableIteration<T, QueryEvaluationException>> result = new QueueIterator<CloseableIteration<T, QueryEvaluationException>>(
			new QueueIterator.ItemReleaser<CloseableIteration<T, QueryEvaluationException>>() {
				@Override
