...
//	static Logger log = LoggerFactory.getLogger(JoinExecutorBase.class);
	...
	// rightQueue = new QueueCursor<CloseableIteration<T,
	// QueryEvaluationException>>(1024);
	private QueueIterator<CloseableIteration<T, QueryEvaluationException>> rightQueue = new QueueIterator<CloseableIteration<T, QueryEvaluationException>>(
