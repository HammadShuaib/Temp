...
//	public static Logger log = LoggerFactory.getLogger(FilteringIteration.class);
	...
	public FilteringIteration(FederationEvalStrategy strategy, FilterValueExpr filterExpr,
			CloseableIteration<BindingSet, QueryEvaluationException> iter) throws QueryEvaluationException {
		super(iter);
