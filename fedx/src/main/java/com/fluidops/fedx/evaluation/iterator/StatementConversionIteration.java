...
/**
 * Converts Statement iteration (i.e. RepositoryResult) into the corresponding
 * binding set. Note that exceptions are converted appropriately as well.
 * 
...
public class StatementConversionIteration extends AbstractCloseableIteration<BindingSet, QueryEvaluationException> {
	...
	public StatementConversionIteration(RepositoryResult<Statement> repoResult, BindingSet bindings,
