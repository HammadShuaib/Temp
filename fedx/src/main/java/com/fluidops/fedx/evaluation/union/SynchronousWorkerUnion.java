...
/**
 * Synchronous execution of union tasks, i.e. one after the other. The union
 * result is contained in this iteration. Note that the union operation is to be
 * executed with the {@link #run()} method
 * 
