...
public class FilteringInsertBindingsIteration extends FilteringIteration {
	...
	public FilteringInsertBindingsIteration(FederationEvalStrategy strategy, FilterValueExpr filterExpr,
			BindingSet bindings, CloseableIteration<BindingSet, QueryEvaluationException> iter)
