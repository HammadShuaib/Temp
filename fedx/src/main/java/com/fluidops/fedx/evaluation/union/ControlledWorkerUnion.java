...
/**
 * Execution of union tasks with {@link ControlledWorkerScheduler}. Tasks can be
 * added using the provided functions. Note that the union operation is to be
 * executed with the {@link #run()} method (also threaded execution is
 * possible). Results are then contained in this iteration.
 *
