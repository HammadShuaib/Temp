 ...
 * {@link StatementPattern} using the provided triple source.
 * 
...
public class ParallelGetStatementsTask implements Callable<CloseableIteration<Statement, QueryEvaluationException>> {
	...
	public ParallelGetStatementsTask(TripleSource tripleSource, RepositoryConnection conn, Resource subj, IRI pred,
