...
public class QueueCursor<E> extends LookAheadIteration<E, QueryEvaluationException> {
	...
	/**
	 * Creates an <tt>QueueCursor</tt> with the given (fixed) capacity and default
	 * access policy.
	 * 
	 ...
	 * 
	 * @param capacity the capacity of this queue
	 * @param fair     if <tt>true</tt> then queue accesses for threads blocked on
	...
	/**
	 * The next time {@link #next()} is called this exception will be thrown. If it
	 * is not a QueryEvaluationException or RuntimeException it will be wrapped in a
