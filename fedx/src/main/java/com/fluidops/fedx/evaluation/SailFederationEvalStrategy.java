 ...
 * important optimization is to use prepared Queries that are already created in
 * the internal representation used by Sesame. This is necessary to avoid String
 * parsing overhead.
 * 
...
public class SailFederationEvalStrategy extends FederationEvalStrategy {
	...
	public CloseableIteration<BindingSet, QueryEvaluationException> evaluateIndependentJoinGroup(
			IndependentJoinGroup joinGroup, BindingSet bindings) throws QueryEvaluationException {
	...
	@Override
	public CloseableIteration<BindingSet, QueryEvaluationException> evaluateIndependentJoinGroup(
			IndependentJoinGroup joinGroup, List<BindingSet> bindings) throws QueryEvaluationException {
...
//			result = new IndependentJoingroupBindingsIteration2(result, bindings);
	...
	public CloseableIteration<BindingSet, QueryEvaluationException> evaluateExclusiveGroup(ExclusiveGroup group,
		...
		// other option (which might be faster for sesame native stores): join over the
		// statements
