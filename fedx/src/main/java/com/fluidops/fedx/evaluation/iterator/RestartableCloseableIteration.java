...
public abstract class RestartableCloseableIteration<E> implements CloseableIteration<E, QueryEvaluationException> {
	...
	/**
	 * Calls {@link #handleClose()} upon first call and makes sure this method gets
	 * called only once.
	 */
	@Override
	...
	/**
	 * Called by {@link #close} when it is called for the first time. By default,
	...
	/**
	 * Called by {@link #restart} when it is called for the first time. By default,
	 * this method does nothing.
	 * 
	 */
