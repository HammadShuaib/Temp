...
public class IndependentJoingroupBindingsIteration3 extends LookAheadIteration<BindingSet, QueryEvaluationException> {
	...
	// a pattern matcher for the binding resolver, pattern:
	// myVar_%outerID%#bindingId, e.g. name_0#0
	...
	private ArrayList<BindingSet> res;
...
/*
		// underlying arraylist serves as map, index corresponds to bindings index (i.e.
		// at most bindings.size() - 1)
