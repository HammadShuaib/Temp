 ...
 * bound joins with VALUES clauses, see
 * {@link SparqlFederationEvalStrategyWithValues}.
 * 
 * It is assumed the the query results contain a binding for "?__index" which
 * corresponds to the index in the input mappings. See {@link QueryStringUtil}
 * for details
 * 
