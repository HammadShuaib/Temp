...
public class CacheUtils {
	...
	/**
	 * Perform a "ASK" query for the provided statement to check if the endpoint can
	 * provide results. Update the cache with the new information.
	 * 
	 * @param cache
	 * @param endpoint
	 * @param stmt
...
*/
	...
	/**
	 * Checks the cache if some endpoint can provide results to the subquery. If the
	 * cache has no knowledge a remote ask query is performed and the cache is
	...
	/**
	 * Checks the cache for relevant statement sources to the provided statement. If
	 * the cache has no knowledge ask the endpoint for further information.
	 * 
	 * @param cache
	 * @param endpoints
	 * @param stmt
