...
public interface CacheEntry extends Serializable {
	...
	/**
	 * Returns HAS_STATEMENTS, if this endpoint can provide results, NONE in the
	 * contrary case.
	 * 
	 * Initially it is pessimistically assumed that each endpoint can provide
	 * result. Hence, if some endpoint is not known to the cache, the cache return
	...
	/**
	 * Returns a list of endpoints for which this cache result has any locally
	 * available data.
	 * 
	...
	/**
	 * Returns true iff this cache result has any local available data for the
	 * specified endpoint.
	 * 
	 * @param endpoint
	 * @return
	...
	/**
	 * Update this cache result, e.g. retrieve contents from web source (Optional
	 * Operation)
	 * 
