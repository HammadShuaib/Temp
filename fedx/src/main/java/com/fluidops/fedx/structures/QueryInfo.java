...
/**
 * Structure to maintain query information during evaluation, is attached to
 * algebra nodes. Each instance is uniquely attached to the query.
 * 
...
public class QueryInfo {
	...
	private static  FedXConnection conn1;
	...
	static ThreadLocal<Integer> priority = new ThreadLocal<Integer>() {
		@Override
	...
	public static FedXConnection getFedXConnection1() {
		return conn1;
	}
//	public QueryManager getQueryManager1() {
//		return conn1.getQueryManager();
//	}
