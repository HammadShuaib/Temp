 ...
 * 
 * NOTE: currently only implemented for {@link Compare}, other filter
 * expressions need to be added. If an unexpected filter expression occurs, the
 * filter evaluation is done locally.
 * 
