...
/*
		...
		Model repositoryServer = graph.filter(repNode,
				SimpleValueFactory.getInstance().createIRI("http://fluidops.org/config#repositoryServer"), null);
		...
		// repositoryName
		Model repositoryName = graph.filter(repNode,
				SimpleValueFactory.getInstance().createIRI("http://fluidops.org/config#repositoryName"), null);
