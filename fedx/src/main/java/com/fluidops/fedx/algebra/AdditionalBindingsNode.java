...
/**
 * Convenience AST node to print the additional values of a
 * {@link ProjectionWithBindings} node
 * 
...
public class AdditionalBindingsNode extends AbstractQueryModelNode {
	...
	public static <X extends Exception> void visit(QueryModelVisitor<X> visitor, List<Binding> additionalValues)
			throws X {
