...
public interface StatementTupleExpr extends TupleExpr, FedXExpr, QueryRef {
	...
	/**
	 * returns true iff this statement has free variables in the presence of the
	 * specified binding set
	 * 
	 * @param binding
	 * @return
	 */
	...
	/**
	 * Retrieve the variable names that are local to this expression, i.e. the ones
