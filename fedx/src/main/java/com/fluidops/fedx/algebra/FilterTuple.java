 ...
 * {@link FilterValueExpr} during evaluation.
 * 
...
public interface FilterTuple {
	...
	/**
	 * register a new filter expression. If the expr has already a filter
	 * registered, the new expression is added to a {@link ConjunctiveFilterExpr}.
	 * 
	 * @param expr
	 */
	...
	/**
	 * 
	 * @return the currently registered filter expressions, usually of type
	 *         {@link FilterExpr} or {@link ConjunctiveFilterExpr}
	 */
