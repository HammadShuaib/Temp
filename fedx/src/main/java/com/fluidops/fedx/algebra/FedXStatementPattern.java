...
public abstract class FedXStatementPattern extends StatementPattern
	...
	protected FedXStatementPattern(Statement st, Object summary, FedXConnection conn) {
		this(QueryAlgebraUtil.toStatementPattern(st),
				new QueryInfo(conn, "getStatements", QueryType.GET_STATEMENTS, summary));
	}

	public void addStatementSource(StatementSource statementSource) {
		//System.out.println("This is addStatementSource:" + statementSource);
	...
	//	System.out.println("This is getFreeVars:" + freeVars);
		return freeVars;
	}
...
//		System.out.println("This is getLocalVars:" + freeVars);
	...
	public void addBoundFilter(String varName, Value value) {
		...
		// if no free vars AND hasResults => replace by TrueNode to avoid additional
		// remote requests
	}
	...
	protected abstract CloseableIteration<BindingSet, QueryEvaluationException> evaluate(BindingSet bindings,
			List<StatementSource> sources);

	protected CloseableIteration<BindingSet, QueryEvaluationException> evaluate(List<BindingSet> bindings,
			List<StatementSource> sources) {
		...
		CloseableIteration<BindingSet, QueryEvaluationException> result = strategy
				.evaluateAtStatementSources(preparedQuery, sources, getQueryInfo());
