...
/**
 * A {@link SailFactory} that initializes FedX Sails based on the provided
 * configuration data.
 * 
...
public class FedXSailFactory implements SailFactory {
	...
	public Sail getSail(SailImplConfig config) throws SailConfigException {
		...
		try {
			return FedXFactory
					.initializeFederation(fedxConfig, new DefaultEndpointListProvider(Collections.<String>emptyList()))
					.getSail();
