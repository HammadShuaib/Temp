	...
	//    if(file1.delete())
	  ...
	  //      System.out.println("File deleted successfully1");
	   // }
	    ...
	    file1 = new File("/mnt/hdd/hammad/hammad/Query.csv");
...
*/
	/*	List<String> endpointsMax = Arrays.asList(
		...
		List<String> endpointsMax = Arrays.asList(
				 "http://" + host + ":8880/A/sparql",
				 "http://" + host + ":8881/Aff/sparql",
				 "http://" + host + ":8882/Chebi/sparql",
				 "http://" + host + ":8883/Db/sparql",
				 "http://" + host + ":8884/Drug/sparql",
				 "http://" + host + ":8885/E/sparql",
				 "http://" + host + ":8886/Geoname/sparql",
				 "http://" + host + ":8887/Jam/sparql",
			 	 "http://" + host + ":8888/Kegg/sparql",
				 "http://" + host + ":8889/LMDB/sparql",
				 "http://" + host + ":8890/M/sparql",
			     "http://" + host + ":8891/NYT/sparql",
				  "http://" + host + ":8892/SWD/sparql"
			);
		...
		Map<String, List<List<Object>>> reports = multyEvaluate(queries, 1, cfgName, endpointsMax);
