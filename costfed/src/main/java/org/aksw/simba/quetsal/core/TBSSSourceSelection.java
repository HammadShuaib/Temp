...
//	private	static final org.apache.log4j.Logger log = LogManager.getLogger(TBSSSourceSelection.class);
...
//org.apache.log4j.Logger.getLogger("org.aksw.simba.quetsal.core.TBSSSourceSelection").setLevel(Level.OFF);
...
//	}
	...
	*/
	 ...
	 */
	public ConcurrentHashMap<StatementPattern, List<StatementSource>> pruneSources(List<Map<String, Vertex>> dNFHyperVertices)
	{
			...
			for (Future<Void> future : futures) {
				try {
					future.get();
			         ...
			         System.err.println("Error during source selection. Thread got interrupted."+e);
